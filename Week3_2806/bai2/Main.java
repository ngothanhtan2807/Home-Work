...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(m1.muonSach(new Book("Nha gia kim", "Author1", 1)));
        System.out.println(m1.muonSach(new Book("Nha gia kim", "Author1", 1)));
        m1.muonSach(new Book("Dac nhan tam", "Author2", 1));
        System.out.println(m2.muonSach(new Book("Nha gia kim", "Author1", 40)));
